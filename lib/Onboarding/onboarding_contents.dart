...
List<OnboardingContents> contents = [
  OnboardingContents(
    ...
    image: "assets/1.png",
    desc: "Let's help you!\nUse HereIAmAlert's great features to ensure your personal safety",
  ),
  OnboardingContents(
  ...
  OnboardingContents(
    ...
    desc:
    "HereIAmAlert detects shake frequency to send alerts",
  ),
  OnboardingContents(
    title: "Help at your fingertips",
    image: "assets/women.png",
    desc:
    "HereIAmAlert instantly connects you with the concerned authorities",
  ),
  OnboardingContents(
  ...
  OnboardingContents(
    ...
    desc:
    "HereIAmAlert uses magnetometers and gyroscopes sensors to detect spy camera",
  ),
  OnboardingContents(
